...
export default function Login() {
    // Sync html + body background with current theme to eliminate the white gap
    // caused by the global zoom: 0.9 on desktop
    useEffect(() => {
    ...
    return (
        <div className="min-h-screen lg:min-h-[calc(100vh/0.9)] flex flex-col w-full bg-slate-950">
            <div className="flex-grow w-full relative flex flex-col overflow-hidden selection:bg-teal-500/30 isolate">
                <Navbar />
